...
<div class="container">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ Route('admin.setting.storeUpdate', ['id' => $setting->id]) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <br>
                            <input type="checkbox" name="encrypt" id="encrypt" <?php if($setting->encrypt == 1) { ?>checked<?php } ?>>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{ $setting->description }}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
